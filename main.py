...
class DBOperations:
  sql_create_flightinfo_table_firsttime = "create table if not exists FlightInfo (id integer primary key autoincrement, FlightNumber string unique not null, DepartureTime)"
  sql_create_flightinfo_table_firsttime = "create table if not exists "
  sql_create_flightinfo_table_firsttime = "create table if not exists "
...
# The user will select a choice from the menu to interact with the database.
  ...
  while True:
    ...
    print(" 8. View Number of Flights for a Destination")
    print(" 9. View Number of Flights assigned to a Pilot")
    print(" 10. Exit\n")
